...
export class ImportsService extends ServiceBase {
    ...
    collection_url = import_id => `${environment.apiUrl}/ansible-galaxy/api/v2/collection-imports/${import_id}/`;
    repo_url = import_id => `${environment.apiUrl}/ansible-galaxy/api/v1/imports/${import_id}/`;
    combined_url = namespace_id =>
        /* tslint:disable */
        `${environment.apiUrl}/ansible-galaxy/api/internal/ui/namespaces/${namespace_id}/imports/`;
