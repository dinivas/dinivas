...
export const computeTerraformModuleTemplateContextForAWS = (
  ...
  switch (moduleId) {
    case 'project_base':
      return computeTerraformProjectBaseModuleTemplateContextForAWS(
        moduleId,
        cloudprovider,
        moduleData,
        projectConsul,
    ...
    case 'jenkins':
      return computeTerraformJenkinsModuleTemplateContextForAWS(
        moduleId,
        cloudprovider,
        moduleData,
        projectConsul,
    ...
    case 'rabbitmq':
      return computeTerraformRabbitMQModuleTemplateContextForAWS(
        moduleId,
        cloudprovider,
        moduleData,
        projectConsul,
    ...
    case 'consul':
      return computeTerraformConsulModuleTemplateContextForAWS(
        moduleId,
        cloudprovider,
        moduleData,
        projectConsul,
    ...
    case 'project_instance':
      return computeTerraformInstanceModuleTemplateContextForAWS(
        moduleId,
        cloudprovider,
        moduleData,
        projectConsul,
    ...
    case 'gitlab':
      return computeTerraformGitlabModuleTemplateContextForAWS(
        moduleId,
        cloudprovider,
        moduleData,
        projectConsul,
...
const computeTerraformProjectBaseModuleTemplateContextForAWS = (
  moduleId: TerraformModule,
  cloudprovider: CloudProviderId,
  ...
  return {
    ...
    aws_region: cloudConfig.region,
    aws_access_key_id: cloudConfig.access_key_id,
    aws_secret_access_key: cloudConfig.secret_access_key,
  };
};

const computeTerraformJenkinsModuleTemplateContextForAWS = (
  moduleId: TerraformModule,
  cloudprovider: CloudProviderId,
  jenkins: JenkinsDTO,
  consul: ConsulDTO,
...
const computeTerraformGitlabModuleTemplateContextForAWS = (
  moduleId: TerraformModule,
  cloudprovider: CloudProviderId,
  gitlab: GitlabDTO,
  consul: ConsulDTO,
...
const computeTerraformInstanceModuleTemplateContextForAWS = (
  moduleId: TerraformModule,
  cloudprovider: CloudProviderId,
...
const computeTerraformConsulModuleTemplateContextForAWS = (
  moduleId: TerraformModule,
  cloudprovider: CloudProviderId,
  consul: ConsulDTO,
  projectConsul: ConsulDTO,
...
const computeTerraformRabbitMQModuleTemplateContextForAWS = (
  moduleId: TerraformModule,
  cloudprovider: CloudProviderId,
...
exports = {
  computeTerraformModuleTemplateContextForAWS,
};
